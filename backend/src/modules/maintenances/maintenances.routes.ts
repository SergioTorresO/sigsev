...
import { list, getOne, create, update, complete } from './maintenances.controller'
...
// Escritura: solo ADMIN y SUPERVISOR pueden crear/editar mantenimientos (asignar a técnicos, etc.)
